...
// https://api.themoviedb.org/3/movie/505864?api_key=215b7388a50135da76601db1ca0183ba&append_to_response=cast%2Cvideos%2Cimages%2Creleases


const getGenres = function(grenlist){
    const newGenreList = [];
    for(const { name } of grenlist){
        newGenreList.push(name);
    }
    return newGenreList.join(", ");
}

const getCarts = function(castList){
    const newCastList = [];
...
const getDirections=function(crewList){
...
const filterVideos = function(videos){
    return videos.filter(({type,site})=>(type ==="Trailer" || type === "Teaser")&& site ==="YouTube");
}
fetchDataFromServer(
    ...
    function(movie){
        ...
        <figure class="poster-box movi-poster">
        ...
        <div class="detail-box">
            <div class="detail-content">
                ...
                <div class="meta-list">
                    <div class="meta-item">
                        <img src="assets/images/star.png" width="20" alt="rating">
